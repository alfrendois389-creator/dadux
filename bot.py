...
# Telegram: Auto Roll, Deposit QRIS, Withdraw, Last Win, Jackpot, Leaderboard, Referral
...
# ==================== KONFIGURASI ====================
BOT_TOKEN = "8986690043:AAFhRUhCU6acJQ3LtTroQ7z7DjBmg4V1kFQ"  # Ganti dengan token lo
ADMIN_IDS = [8502398484]            # Ganti dengan ID Telegram lo
